    ...
    def cadastrarCliente(self):
        ...
        if nome != '' and sobrenome != '' and cpf != '' and senha != '':
            ...
            if resposta[0] == "True":
                ...
                QMessageBox.information(None, "HNBANK",
                                        f"Cadastro feito com sucesso\n\nNumero da conta: " + resposta[1])
                self.voltarTelaInicial()

            else:
                QMessageBox.information(None, "HNBANK", "Falha ao cadastrar dados do cliente")

        else:
            QMessageBox.information(None, "HNBANK", "Preencha todos os campos")
    ...
    def logarCliente(self):
        ...
        if numero_da_conta != '' and senha != '':
            ...
            if resposta[0] == "True":
                ...
                QMessageBox.information(None, "HNBANK", "Falha no login")
        else:
            QMessageBox.information(None, "HNBANK", "Preencha todos os campos")
    ...
    def saqueConfirmar(self):
        ...
        try:
            if valor_a_ser_sacado != '':
                ...
                if resposta[0] == "True":
                    QMessageBox.information(None, "HNBANK", "Saque realizado com sucesso")
                    self.entrarTelaPrincipal()
                else:
                    QMessageBox.information(None, "HNBANK", "Valor invalido\nou\nMaior que o saldo")
            else:
                QMessageBox.information(None, "HNBANK", "Preencha o campo")
        except:
            QMessageBox.information(None, "HNBANK", "Ocorreu um erro")
    ...
    def depositoConfirmar(self):
        ...
        try:
            if valor_a_ser_depositado != '':
                ...
                if resposta[0] == "True":
                    QMessageBox.information(None, "HNBANK", "Deposito realizado com sucesso")
                    self.entrarTelaPrincipal()
                else:
                    QMessageBox.information(None, "HNBANK", "Valor invalido\nou\nPassa do limite")
            else:
    ...
    def transferirSaldo(self):
        ...
        try:
            if numero_da_conta_do_destinatario != '' and valor_a_ser_transferido != '':
                ...
                if resposta[0] == "True":
                    QMessageBox.information(None, "HNBANK", "Transferencia realizada com sucesso\n")
                    self.entrarTelaPrincipal()
                else:
                    QMessageBox.information(None, "HNBANK", "Valor invalido")
            else:
                QMessageBox.information(None, "HNBANK", "Preencha os campos necessarios")
        except:
            QMessageBox.information(None, "HNBANK", "Ocorreu um erro")
        ...
        try:
            if numero_da_conta_do_destinatario != '':
                if resposta[0] == "True":
                    ...
                    QMessageBox.information(None, "HNBANK", "Destinatário não encontrado")
                    self.tela_transferir.nome_do_destinatario_line.setText('')
                    self.tela_transferir.cpf_do_destinatario_line.setText('')
            else:
                QMessageBox.information(None, "HNBANK", "Informe o numero da conta do destinatario")
                self.tela_transferir.nome_do_destinatario_line.setText('')
                self.tela_transferir.cpf_do_destinatario_line.setText('')
        except:
            QMessageBox.information(None, "HNBANK", "Ocorreu um erro")
